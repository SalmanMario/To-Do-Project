...
export function Terms() {
  return (
    <Box sx={{ m: 3 }}>
      ...
      <Typography>Welcome to My-To-Do-Project!</Typography>

      <Typography>
        These terms and conditions outline the rules and regulations for the use of Project Corporation 's Website,
        located at https://todoprojectfirebase.netlify.app.
      </Typography>

      <Typography>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use
        My-To-Do-Project if you do not agree to take all of the terms and conditions stated on this page.
      </Typography>
      ...
      <Typography>
        ...
        Company's stated services, in accordance with and subject to, prevailing law of ro. Any use of the above
      ...
      <Typography>
        We employ the use of cookies. By accessing My-To-Do-Project, you agreed to use cookies in agreement with the
        Project Corporation 's Privacy Policy.{" "}
      </Typography>
      ...
      <Typography>
        Unless otherwise stated, Project Corporation and/or its licensors own the intellectual property rights for all
        material on My-To-Do-Project. All intellectual property rights are reserved. You may access this from
        My-To-Do-Project for your own personal use subjected to restrictions set in these terms and conditions.
      </Typography>

      <Typography>You must not:</Typography>
      <Typography sx={{ mx: 3 }}>
        <li>Republish material from My-To-Do-Project</li>
        <li>Sell, rent or sub-license material from My-To-Do-Project</li>
        <li>Reproduce, duplicate or copy material from My-To-Do-Project</li>
        <li>Redistribute content from My-To-Do-Project</li>
      </Typography>
      ...
      <Typography>
        ...
        areas of the website. Project Corporation does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions of Project Corporation ,its agents
        and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Project Corporation shall not be liable for the Comments or for any
        liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or
        appearance of the Comments on this website.
      </Typography>

      <Typography>
        Project Corporation reserves the right to monitor all Comments and to remove any Comments which can be
      ...
      <Typography>
        You hereby grant Project Corporation a non-exclusive license to use, reproduce, edit and authorize others to
      ...
      <Typography>The following organizations may link to our Website without prior written approval:</Typography>
      ...
      <Typography>
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Project
        Corporation ; and (d) the link is in the context of general resource information.
      </Typography>
      ...
      <Typography>
        ...
        you must inform us by sending an e-mail to Project Corporation . Please include your name, your organization
      ...
      <Typography>
        No use of Project Corporation 's logo or other artwork will be allowed for linking absent a trademark license
        agreement.
      </Typography>
